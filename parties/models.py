...
class Party(mixins.TimestampModelMixin, mixins.OwnerModelMixin, mixins.SoftDeleteModelMixin):
    ...
    """
    name = models.CharField(unique=True,max_length=255, help_text="Nome da parte. Deve ser único.")
    ...
    phone = models.CharField(max_length=20, validators=[regex.phone_regex], help_text="Número de telefone da parte.",null=True, blank=True)
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['name'], name='unique_party_name'),
        ]
