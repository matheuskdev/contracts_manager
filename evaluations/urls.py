...
urlpatterns = [
    ...
    path('evaluations/create/<int:contract_id>/', views.EvaluationCreateView.as_view(), name='evaluation_create'),
    path('evaluations/<int:pk>/edit/', views.EvaluationUpdateView.as_view(), name='evaluation_update'),
